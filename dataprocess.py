...
def main():
    input_path = Path(r'D:\Brandeis University\Interview Challanges\CBH_unsupervised\Dataset\drugsCom_raw')
    output_path = Path(r'D:\Brandeis University\Interview Challanges\CBH_unsupervised')
